...
.asset-thumbnail img{width:100%;height:100%;object-fit:cover}.asset-thumbnail.is-large img,.asset-thumbnail.is-catalog img,.asset-thumbnail.is-tile img{object-fit:contain;background:color-mix(in srgb,var(--bg-base) 88%,var(--accent-soft))}
