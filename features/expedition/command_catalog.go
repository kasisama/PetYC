...
func commandDefinitions() []commandDefinition {
	return []commandDefinition{
		...
		{feature("adopt_detail", "领养详情", "领养伙伴详情", "基础", "查看候选宠物的完整特点与成长方向", 11), handleAdoptDetail},
		...
		{feature("daily_checkin", "签到", "每日签到", "基础", "完成每日签到并领取陪伴奖励", 30, "宠物签到"), handleDaily},
		{feature("today_todo", "今日待办", "今日待办", "基础", "根据当前状态推荐今天优先进行的事情", 31, "今日", "待办", "今天做什么"), handleTodayTodo},
		...
		{hiddenFeature("adventure_event_choice", "探索选择", "探索事件选择", "远征", "处理当前区域探索事件的一个选项", 222), handleAdventureEventChoice},
		...
		{feature("fishing_cast", "抛竿", "抛竿", "扩展", "消耗星砂开始一次垂钓", 231), handleCastFishing},
		...
		{feature("trade", "宠物交易", "安全交易", "扩展", "发布物品与星砂的托管交易", 260, "交易", "添加交易"), handleTrade},
