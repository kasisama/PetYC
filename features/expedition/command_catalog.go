...
func commandDefinitions() []commandDefinition {
	return []commandDefinition{
		...
		{feature("equipment", "装备", "宠物装备", "远征", "查看武器、防具和秘宝", 227), handleEquipment},
		...
		{feature("blueprints", "蓝图", "装备蓝图", "远征", "查看蓝图碎片和已解锁配方", 230), handleBlueprints},
		...
		{hiddenFeature("legacy_family", "创建家族", "家族玩法引导", "兼容", "引导到社区小队与共建玩法", 930,
			"加入家族", "注销家族", "退出家族", "我的家族", "家族列表", "家族成员", "踢出成员", "神树浇水"), handleLegacyFamily},
	}
}
