...
type ConfigSnapshot struct {
	...
	AdventureStages           []models.AdventureExplorationStageConfig `json:"adventure_stages"`
	AdventureStoryEvents      []models.AdventureStoryEventConfig       `json:"adventure_story_events"`
	AdventureStoryChoices     []models.AdventureStoryEventChoiceConfig `json:"adventure_story_choices"`
...
func CaptureSnapshot(db *gorm.DB) (ConfigSnapshot, error) {
	...
	queries := []struct {
		...
		{&snapshot.AdventureStages, "zone_key asc, sort_order asc, key asc"}, {&snapshot.AdventureStoryEvents, "zone_key asc, stage_key asc, sort_order asc, key asc"},
		{&snapshot.AdventureStoryChoices, "event_key asc, sort_order asc, choice_key asc"},
